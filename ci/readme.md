```shell
docker run --rm  -v $PWD:/project -v /home/.npm_cache/{PROJECT_NAME}:/cache -e files="node_modules,src" -e command="yarn run build;yarn run test"  longfei59418/ci_build:tagname
```
...
#### 参数
- dirPath: 用于缓存的宿主机目录。 eg: /home/.npm_cache/{PROJECT_NAME}
- $PWD: 项目目录
